...
let package = Package(
        ...
        dependencies: [
          ...
          .package(url: "https://github.com/oshishin1/EvmKit.Swift.git", .upToNextMajor(from: "2.0.0")),
          .package(url: "https://github.com/oshishin1/Eip20Kit.Swift.git", .upToNextMajor(from: "2.0.0")),
